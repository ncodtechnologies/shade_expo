...
import { PdfSundryCr } from '../pdf/sundryCreditor';
                  ...
                  <div class="card-body p-0">
                    <table class="table">
                      ...
                      <tfoot>
                        ...
                        <th></th>                      
                        <th></th>                      
                        <th style={{textAlign: "right"}} >{Math.round(total)} CR</th>
                      </tfoot>
                    </table>
                  </div>
                  ...
                  <div class="card-body">
                    <div class="row">
                      <PDFViewer style={{width:"100%", height: 500}} >
                        <PdfSundryCr arrVouchers={this.state.arrVouchers} date={this.formatDate(this.state.date)} />
                      </PDFViewer>
                    </div>
                  </div>
                  </div>
