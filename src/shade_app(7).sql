...
--
-- Host: 127.0.0.1
-- Generation Time: May 22, 2020 at 11:53 AM
...
INSERT INTO `account_head` (`id_account_head`, `code`, `name`, `id_ledger_group`, `opening_balance`, `address`, `phone`) VALUES
(1, 'LABOUR', 'LABOUR', 6, 0, '', ''),
...
(27, 7, 18, '2020-05-15 00:00:00', 'gf', 0, 4500, 'Payment', 1, 0),
(28, 10, 2, '2020-05-07 00:00:00', 'gf', 0, 48500, 'Receipt', 1, 1),
(29, 8, 10, '2020-05-15 00:00:00', 'gfjh', 0, 4100, 'Receipt', 1, 1),
(30, 5, 1, '2020-05-18 00:00:00', ' blum', 66, 12500, 'Payment', 1, 1),
(31, 0, 1, '2020-05-20 00:00:00', 'jhbh', 78, 57858, 'Payment', 1, 1),
(32, 0, 1, '2020-05-20 00:00:00', 'asd', 100, 1000, 'Payment', 1, 1),
(33, 0, 1, '2020-05-20 00:00:00', 'fghvbn', 600, 1200, 'Payment', 1, 1);
...
CREATE TABLE `invoice_items` (
  `id_invoice_items` int(11) NOT NULL,
  `id_invoice` int(11) NOT NULL,
...
INSERT INTO `invoice_items` (`id_invoice_items`, `id_invoice`, `id_product`, `kg`, `amount`, `total`) VALUES
(1, 1, 2, 50, 100, 1500),
(2, 2, 2, 100, 1200, 3500);
...
(25, '2020-05-18 00:00:00', 10, 'Salary', 3500),
(26, '2020-05-18 00:00:00', 19, 'Loan', 2400);
...
INSERT INTO `product` (`id_product`, `name`, `unit`, `purchase_price`, `selling_price`, `category`, `type`) VALUES
(1, 'PRODUCT1', 'a', 1000, 1200, 0, 'FISH'),
(2, 'PROD1', 'P1', 1150, 1200, 0, 'FISH'),
(3, 'PROD2', 'hg', 1000, 500, 0, 'OTHER'),
(4, 'SAD', 'ZC', 100, 200, 0, 'FISH'),
(5, 'PROD3', 'F', 2000, 2500, 0, 'OTHER'),
(6, 'PROD4', 'PR4', 1000, 1200, 0, 'FISH'),
(7, 'P5', '5', 1200, 1400, 0, 'FISH'),
(8, 'QWERTY', '3', 100, 300, 0, 'OTHER'),
(9, 'R', 'F', 3, 20, 0, 'OTHER'),
(10, 'F', 'Y', 8, 10, 0, '');
...
(3, '2020-05-21 00:00:00', 1, 'nnnnn', 'mmm');
...
--
-- Dumping data for table `rough_invoice_items`
--

INSERT INTO `rough_invoice_items` (`id_rough_invoice_items`, `id_rough_invoice`, `id_product`, `kg`, `box`, `total`) VALUES
(1, 3, 8, 12, 100, 1200),
(2, 3, 5, 20, 5, 100),
(3, 1, 7, 56, 7, 392);
...
(1, 1, '2020-04-22', 1, 0, 3600, '', 3127590, ''),
(2, 2, '2020-04-22', 1, 0, 9000, '', 3127590, '');
...
(1, 2, 60, 0, 60, 3600, 1, NULL),
(2, 3, 100, 0, 90, 9000, 2, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `z_stock`
--

CREATE TABLE `z_stock` (
...
--
-- Dumping data for table `z_stock`
--

INSERT INTO `z_stock` (`id_stock`, `date`, `id_product`, `quantity`, `type`, `rate`) VALUES
(1, '2020-04-22 17:30:12', 2, 10, 'FISH', 2500),
(2, '2020-04-20 17:30:12', 3, 15, 'OTHER', 3500),
(3, '2020-04-08 14:20:10', 2, 5, 'FISH', 17000),
(4, '2020-04-15 14:20:10', 3, 8, 'FISH', 5000),
(5, '2020-04-23 00:00:00', 1, 12, 'FISH', 100),
(6, '2020-04-23 00:00:00', 2, 34, 'OTHER', 100);
...
ALTER TABLE `invoice_items`
  ADD PRIMARY KEY (`id_invoice_items`);
...
--
ALTER TABLE `account_voucher`
  MODIFY `id_account_voucher` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `invoice_items`
  MODIFY `id_invoice_items` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `payroll`
  MODIFY `id_payroll` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
...
--
ALTER TABLE `rough_invoice`
  MODIFY `id_rough_invoice` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `rough_invoice_items`
--
ALTER TABLE `rough_invoice_items`
  MODIFY `id_rough_invoice_items` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `z_sales_voucher`
  MODIFY `id_sales_voucher` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `z_sales_voucher_item`
--
ALTER TABLE `z_sales_voucher_item`
  MODIFY `id_sales_voucher_item` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `z_stock`
--
ALTER TABLE `z_stock`
